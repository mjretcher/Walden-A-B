    ...
    <AppShell user={user}>
      ...
      <Panel className="mt-8">
        ...
        <div className="grid gap-3 md:grid-cols-2 xl:grid-cols-4">
          <a className="rounded-xl border border-slate-200 bg-white p-4 transition hover:border-lake-200 hover:bg-lake-50/40" href="/admin/campers?cabin=__NO_CABIN__"><p className="text-sm font-bold uppercase tracking-wide text-slate-400">Missing cabin</p><p className="mt-1 text-3xl font-black text-forest-900">{missingCabinCampers.length}</p><p className="mt-2 text-sm text-slate-500">Active campers without a cabin assignment.</p></a>
          <a className="rounded-xl border border-slate-200 bg-white p-4 transition hover:border-lake-200 hover:bg-lake-50/40" href="/admin/campers"><p className="text-sm font-bold uppercase tracking-wide text-slate-400">No registrations</p><p className="mt-1 text-3xl font-black text-forest-900">{noRegistrationCampers.length}</p><p className="mt-2 text-sm text-slate-500">Campers not yet placed in any active activity.</p></a>
          <a className="rounded-xl border border-slate-200 bg-white p-4 transition hover:border-lake-200 hover:bg-lake-50/40" href="/admin/campers"><p className="text-sm font-bold uppercase tracking-wide text-slate-400">Partial schedules</p><p className="mt-1 text-3xl font-black text-forest-900">{partialScheduleCampers.length}</p><p className="mt-2 text-sm text-slate-500">Campers with fewer than 8 active A/B registrations.</p></a>
          <a className="rounded-xl border border-slate-200 bg-white p-4 transition hover:border-lake-200 hover:bg-lake-50/40" href="/admin/campers"><p className="text-sm font-bold uppercase tracking-wide text-slate-400">Medical flags</p><p className="mt-1 text-3xl font-black text-forest-900">{medicalFlagCampers.length}</p><p className="mt-2 text-sm text-slate-500">Campers with notes that may affect activity placement.</p></a>
        </div>
      </Panel>
      ...
      <Panel className="mt-8">
        ...
        <div className="grid gap-3 md:grid-cols-2 xl:grid-cols-4">
          <a className="rounded-xl border border-slate-200 bg-white p-4 transition hover:border-lake-200 hover:bg-lake-50/40" href="/area-dashboard"><p className="text-sm font-bold uppercase tracking-wide text-slate-400">Empty offerings</p><p className="mt-1 text-3xl font-black text-forest-900">{emptyOfferings.length}</p><p className="mt-2 text-sm text-slate-500">Active activities with no campers registered.</p></a>
          <a className="rounded-xl border border-slate-200 bg-white p-4 transition hover:border-lake-200 hover:bg-lake-50/40" href="/area-dashboard"><p className="text-sm font-bold uppercase tracking-wide text-slate-400">Approval-only</p><p className="mt-1 text-3xl font-black text-forest-900">{approvalOnlyOfferings.length}</p><p className="mt-2 text-sm text-slate-500">Offerings requiring approval instead of normal capacity.</p></a>
          <a className="rounded-xl border border-slate-200 bg-white p-4 transition hover:border-lake-200 hover:bg-lake-50/40" href="/area-dashboard"><p className="text-sm font-bold uppercase tracking-wide text-slate-400">No staff</p><p className="mt-1 text-3xl font-black text-forest-900">{noStaffOfferings.length}</p><p className="mt-2 text-sm text-slate-500">Offerings with zero staff currently assigned.</p></a>
          <a className="rounded-xl border border-slate-200 bg-white p-4 transition hover:border-red-200 hover:bg-red-50/40" href="/area-dashboard"><p className="text-sm font-bold uppercase tracking-wide text-slate-400">Over capacity</p><p className="mt-1 text-3xl font-black text-forest-900">{overCapacity.length}</p><p className="mt-2 text-sm text-slate-500">Offerings above their configured roster limit.</p></a>
        </div>
      </Panel>

      <Panel className="mt-8">
        <SectionHeader title="Operations Hub" eyebrow="Quick launch" description="Jump directly into the highest-use camp operations workflows."><Badge tone="blue">One-tap workflows</Badge></SectionHeader>
        <div className="grid gap-3 md:grid-cols-2 xl:grid-cols-3">
          <a className="rounded-xl border border-slate-200 bg-white p-4 transition hover:border-lake-200 hover:bg-lake-50/40" href="/admin/campers"><p className="font-bold text-forest-900">Camper Management</p><p className="mt-1 text-sm text-slate-500">Search campers, adjust cabins, view registrations, and manage swim levels.</p></a>
          <a className="rounded-xl border border-slate-200 bg-white p-4 transition hover:border-lake-200 hover:bg-lake-50/40" href="/registration"><p className="font-bold text-forest-900">Registration</p><p className="mt-1 text-sm text-slate-500">Add campers to activities with capacity and approval visibility.</p></a>
          <a className="rounded-xl border border-slate-200 bg-white p-4 transition hover:border-lake-200 hover:bg-lake-50/40" href="/attendance"><p className="font-bold text-forest-900">Attendance</p><p className="mt-1 text-sm text-slate-500">Load rosters, mark attendance, and track missing campers.</p></a>
          <a className="rounded-xl border border-slate-200 bg-white p-4 transition hover:border-lake-200 hover:bg-lake-50/40" href="/switches"><p className="font-bold text-forest-900">Switches</p><p className="mt-1 text-sm text-slate-500">Create, review, approve, or deny camper and staff schedule changes.</p></a>
          <a className="rounded-xl border border-slate-200 bg-white p-4 transition hover:border-lake-200 hover:bg-lake-50/40" href="/area-dashboard"><p className="font-bold text-forest-900">Area Dashboard</p><p className="mt-1 text-sm text-slate-500">Review A/B day periods, staffing, capacity, and area assignments.</p></a>
          <a className="rounded-xl border border-slate-200 bg-white p-4 transition hover:border-lake-200 hover:bg-lake-50/40" href="/rosters"><p className="font-bold text-forest-900">Rosters</p><p className="mt-1 text-sm text-slate-500">Print activity rosters and attendance-ready class sheets.</p></a>
        </div>
      </Panel>
    </AppShell>
  );
