          ...
          {ATHLETICS_STATIONS.map((station) => (
            <tr key={station.key}>
              ...
              {periods.map((period) => {
                ...
                return <td key={period}>{entries.length ? entries.join(" / ") : null}</td>;
              })}
            </tr>
          ))}
        </tbody>
