...
ALTER TABLE "Camper"
  ...
  ADD COLUMN "campGrade" TEXT;

ALTER TABLE "Staff"
  ADD COLUMN "age" DOUBLE PRECISION,
  ADD COLUMN "position" TEXT,
  ADD COLUMN "position2" TEXT,
  ADD COLUMN "employmentStart" TIMESTAMP(3),
  ADD COLUMN "employmentEnd" TIMESTAMP(3),
  ADD COLUMN "screamEligible" BOOLEAN NOT NULL DEFAULT true;
